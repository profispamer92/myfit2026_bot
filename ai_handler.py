...
4. **Скрины FatSecret** — определяй сам:
   ...
   **Несколько фото за раз** — пользователь может прислать несколько скринов которые относятся к одному дню (например 15 разных приёмов пищи из FatSecret). Анализируй ВСЕ фото вместе и складывай данные в один ответ. Не дублируй приёмы пищи если они есть на разных скринах.
