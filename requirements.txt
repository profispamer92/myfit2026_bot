...
- Цель: конкретная (например "хочу 15% жира" или "хочу весить 85кг") или общая (сушка / набор / поддержание)
...
PLAN_JSON:{"calories":2200,"protein":180,"fat":65,"carbs":220,"schedule":{"monday":{"name":"Грудь и трицепс","time":"18:00"}},"profile":{"weight":82,"height":180,"age":28,"gender":"male","fat_percent":18,"goal":"cut","goal_type":"fat_percent","goal_value":15,"activity":"moderate"},"summary":"краткое резюме на 1 предложение включая цель и сколько примерно недель"}

goal_type: "fat_percent" | "weight" | "cut" | "bulk" | "maintain"
goal_value: число (целевой % жира или вес в кг) или null если цель общая"""
